...
void irq_handle(TrapFrame *tf)
{
    ...
    //printk("\33[1;35m tf->irq: %d \33[0m\n", tf->irq);
    //printk("\33[1;35m tf->eax: %d \33[0m\n", tf->eax);
    //printk("\33[1;35m tf->edx: %d \33[0m\n", tf->edx); 
    //printk("\33[1;35m tf->ecx: %d \33[0m\n", tf->ecx); 
    //printk("\33[1;35m tf->ebx: %d \33[0m\n", tf->ebx); 
	if (irq < 0)
	{
