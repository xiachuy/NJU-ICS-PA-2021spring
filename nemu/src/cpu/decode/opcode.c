...
instr_func opcode_entry[256] = {
    ...
    /* 0x68 - 0x6b*/ push_i_l, imul_irm2r_v, push_i_b, imul_i8rm2r_v,
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v, mov_rm2sreg_w, inv,
    ...
    /* 0xe4 - 0xe7*/ in_immport2a_b, in_immport2a_v, out_a2immport_b, out_a2immport_v,
    /* 0xe8 - 0xeb*/ call_near, jmp_near, jmp_far_imm, jmp_short,
    /* 0xec - 0xef*/ in_edxport2a_b, in_edxport2a_v, out_a2edxport_b, out_a2edxport_v,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_near_indirect, inv, jmp_near_indirect, inv, push_m_v, inv};
